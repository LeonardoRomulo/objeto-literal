...
let tamanho_colecao = curiosidades_chuck_norris.length // Criamos aqui uma variável para guardar o tamanho da coleção de objetos

let numero_sorteado = Math.floor(Math.random() * tamanho_colecao); //Criamos uma variável para guardar o número aleatório sorteado.

let curiosidade_escolhida = curiosidades_chuck_norris[numero_sorteado]; // a variável curiosidade escolhida irá receber a curiosidade sorteada por meio do índice do objeto sorteado

let titulo_curiosidade = curiosidade_escolhida.titulo;// Criamos a variável para guardar o titulo da curiosidade do número aleatório que foi sorteado
